...
Watermark.Text = "ahhhh stupid watermark"
...
Close.Text = "X"
Close.BackgroundColor3 = Color3.fromRGB(0, 255, 0) -- Green
...
local MINi = Instance.new("UICorner")
MINi.CornerRadius = UDim.new(0, 15)
MINi.Parent = Close
